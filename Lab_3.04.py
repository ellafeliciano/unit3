...
Aliasing
--------
1.  Will updating b affect a? Explain why or why not? No because both variables refer to the same object.
a = [1, 2, 4]
b = a
...
Problem 1 - declare var_2 as a global variable
---------
var_1 = 'cat'
var_2 = 'dog'
​
...
def add2_multiply(multiplier):
    global my_num
    my_num = (my_num + 2) * multiplier

print("Initial value of my_num: {0}" .format(my_num)) 
add2_multiply(10)
print("Final value of my_num: {0}" .format(my_num))
